...
Revision ID: 4350d72b51b9
Revises: 
Create Date: 2025-02-22 15:25:59.825969
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('editor', 'admin', 'reader', name='user_roles'), server_default='editor', nullable=False),
